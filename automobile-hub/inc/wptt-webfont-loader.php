...
if ( ! function_exists( 'automobile_hub_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function automobile_hub_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
...
if ( ! function_exists( 'automobile_hub_wptt_get_web_font_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function automobile_hub_wptt_get_web_font_url( $url, $format = 'woff2' ) {
		$font = new Automobile_Hub_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
